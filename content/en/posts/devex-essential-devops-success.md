...
It is about their every interaction with systems, tools, and processes. I touched on this in a recent post about the [evolution of Integrated Development Environments](https://jmeiss.me/posts/ide-devex-journey-text-editor-to-cloud/) (IDEs) from text-based editors to Cloud-based IDEs. The post explains how the overall Developer Experience with software development has evolved, leading to where we sit with IDEs now. Things we didn't know we would want back in the 1960s are commonplace and the expected norm now in the 2020s.
